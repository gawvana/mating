...
async def capture_sheet():
    ...
    try:
        ...
        async with websockets.connect(ws_url) as ws:
            ...
            # Click FAB button to open sheet
            await send("Runtime.evaluate", {
            ...
            if "data" in shot:
                ...
                with open(os.path.join(OUT_DIR, "add_sheet_open_dark.png"), "wb") as f:
                    f.write(b)
                print("Captured add_sheet_open_dark.png")

            # Click AI tab inside sheet
            await send("Runtime.evaluate", {
            ...
            if "data" in shot2:
                ...
                with open(os.path.join(OUT_DIR, "add_sheet_ai_tab_dark.png"), "wb") as f:
                    f.write(b2)
                print("Captured add_sheet_ai_tab_dark.png")

    finally:
        proc.terminate()

if __name__ == "__main__":
    asyncio.run(capture_sheet())
